...
//home_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_heading', array(
         ...
         'label' => __( 'Posts', 'store-wp' ),
         'description' => __( '', 'store-wp' ),
...
//home_posts_per_page
    ...
    $wp_customize->add_control('home_posts_per_page', array(
        'label' => __('', 'store-wp'),
        'description' => __('Change the number of posts showed in the home page.', 'store-wp'),
        'type' => 'number',
        'section' => 'home-settings',
...
//home_portfolio_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_portfolio_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Portfolio section', 'store-wp' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-portfolio/" target="_blank">IG Portfolio</a> plugin.', 'store-wp' ),
         'active_callback' => 'is_home',
    ) ) );
//home_portfolio
    ...
    $wp_customize->add_control('home_portfolio', array(
        'label' => __('Enable portfolio section?', 'store-wp'),
        'description' => __('', 'store-wp'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_portfolio_title
    $wp_customize->add_setting('home_portfolio_title', array(
        'default' => __('Our new projects', 'store-wp'),
        'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
    $wp_customize->add_control('home_portfolio_title', array(
        'label' => __('', 'store-wp'),
        'description' => __('Section title', 'store-wp'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_portfolio_description
    $wp_customize->add_setting('home_portfolio_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('See our latest works!', 'store-wp'),
         'active_callback' => 'is_home',
    ));
    $wp_customize->add_control('home_portfolio_description', array(
        'label' => __('', 'store-wp'),
        'description' => __('Section description', 'store-wp'),
        'type' => 'textarea',
        'section' => 'home-settings',
...
//home_portfolio_tax
    ...
    $wp_customize->add_control('home_portfolio_tax', array(
        'label' => __('', 'store-wp'),
        'description' => __('Write the slug of the category you want to show', 'store-wp'),
        'type' => 'text',
        'section' => 'home-settings',
...
//home_testimonials_heading
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'home_testimonials_heading', array(
         'section' => 'home-settings',
         'label' => __( 'Testimonials section', 'store-wp' ),
         'description' => __( 'To use this section you must download and install our free <a href="https://wordpress.org/plugins/ig-testimonals/" target="_blank">IG Testimonials</a> plugin.', 'store-wp' ),
         'active_callback' => 'is_home',
    ) ) );
//home_testimonials
    ...
    $wp_customize->add_control('home_testimonials', array(
        'label' => __('Enable testimonials section?', 'store-wp'),
        'description' => __('', 'store-wp'),
        'type' => 'checkbox',
        'section' => 'home-settings',
...
//home_testimonials_title
    $wp_customize->add_setting('home_testimonials_title', array(
        'default' => __('What our clients says', 'store-wp'),
         'sanitize_callback' => 'igthemes_sanitize_textarea',
    ));
...
//home_testimonials_description
    $wp_customize->add_setting('home_testimonials_description', array(
        'sanitize_callback' => 'igthemes_sanitize_text',
        'default' => __('We make every thing with best quality, our customers and partners are very happy!', 'store-wp'),
    ));
...
//Header layout
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'header-layout', array(
        'label' => esc_html__('Layout', 'onepage'),
        'description' => esc_html__('', 'onepage'),
...
******************************************************************/
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'font-family', array(
        'label' => esc_html__('Font family', 'onepage'),
        'description' => esc_html__('', 'onepage'),
        'section' => 'typography-settings',
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'font-size', array(
        'label' => esc_html__('Font size', 'onepage'),
        'description' => esc_html__('', 'onepage'),
        'section' => 'typography-settings',
        'settings' => 'font-size',
        'priority' => 9
...
******************************************************************/
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'footer-content', array(
        'label' => esc_html__('Footer content', 'onepage'),
        'description' => esc_html__('', 'onepage'),
        'section' => 'footer-settings',
...
******************************************************************/
    ...
    $wp_customize->add_control( new IGthemes_Heading( $wp_customize, 'shop-buttons', array(
        'label' => esc_html__('Buttons', 'onepage'),
        'description' => esc_html__('', 'onepage'),
        'section' => 'shop-settings',
