...
class IGthemes_More_Control extends WP_Customize_Control {
    ...
    public function render_content() { ?>
            ...
            <?php endif; ?>
            <p>
                <?php esc_html_e( 'Base WP Premium expands the already powerful free version of this theme and gives access to our priority support service.', 'onepage' ); ?>
            <ul>
                <li><?php esc_html_e( 'All options enabled', 'onepage' ); ?></li>
                <li><?php esc_html_e( 'Custom widgets', 'onepage' ); ?></li>
                <li><?php esc_html_e( 'Custom page and post settings', 'onepage' ); ?></li>
                <li><?php esc_html_e( 'Premium support', 'onepage' ); ?></li>
                <li><?php esc_html_e( 'Money back guarantee', 'onepage' ); ?></li>
            </ul>
            <a href="<?php echo esc_url( 'http://www.iograficathemes.com/downloads/onepage-premium' ); ?>" target="_blank" class="button-upgrade">
...
class IGthemes_Only_Premium extends WP_Customize_Control {
    ...
    public function render_content() { ?>
            ...
            <span class="customize-control-description">
                ...
                <a href="<?php echo esc_url('http://www.iograficathemes.com/downloads/onepage-premium/'); ?>">
                    <?php esc_html_e( ' - only premium', 'onepage' ); ?>
                </a>
            </span>
        <?php
    }
