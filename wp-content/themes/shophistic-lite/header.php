	...
	<div id="wrap">
            ...
            <header id="header">
                <div class="container">
                    <div class="row">
											<div class="contacts">
												<p class="tel">&#9990;Телефон 380662613113</p>
											</div>
                        <div class="ql_logo_nav col-md-9 col-xs-12">
                            ...
                            <div class="logo_container">
                                <a href="<?php echo home_url(); ?>/" class="ql_logo google-font">
                                    ...
                                    <img class="logowid" src="/wp-content/uploads/2017/01/logo-1.png">
                                </a>
                                    ...
                                    <div id="ql_woo_cart">
                                        ...
                                        <?php the_widget('WC_Widget_Cart');  ?>
																...
																<div class="login_btn_wrap">
																	<button id="but_car" type="button" name="car">Выберите авто</button>
                                </div>
                                <div class="clearfix"></div>
                            </div><!-- col-md-4 -->
...
<div id="menu-2">
	<a class="m-1"href="http://u95903dx.bget.ru/защита/">ЗАЩИТА</a><a class="m-2"href="http://u95903dx.bget.ru/компрессоры/">КОМПРЕССОРЫ</a><a class="m-3"href="http://u95903dx.bget.ru/кунги/">ШИНЫ</a><a class="m-4"href="http://u95903dx.bget.ru/лебёдки/">ЛЕБЁДКИ</a><a class="m-5"href="http://u95903dx.bget.ru/такелаж/">ТАКЕЛАЖ</a>
</div>
